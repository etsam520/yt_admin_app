    ...
    <div class="p-4">
        ...
        <div class="p-4">
            <Bulkimportfile
                ...
                :extra-data="{ organisationId: question.organization, subjectId: question.subject_id, chapterId: question.chapter_id, topicId: question.topic_id, questionGroup: QUESTION_GROUPS.find((group) => group.key == 'PYQ').value }"
