    ...
    /> -->
        ...
        <div class="p-4">
            <QuestionForm
                ...
                :questionMeta="{ organisationId: question.organization, subjectId: question.subject_id, chapterId: question.chapter_id, topicId: question.topic_id, questionGroup: QUESTION_GROUPS.find((group) => group.key == 'NPQ').value }"
            />
        </div>
    </div>
</template>
