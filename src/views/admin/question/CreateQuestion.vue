...
export default {
    ...
    mounted() {
        console.log('quetiosn group', QUESTION_GROUPS);
        this.loadSubjects();
    ...
    /> -->
        ...
        <div class="p-4">
            <QuestionForm
                ...
                :questionMeta="{ organisationId: question.organization, subjectId: question.subject_id, chapterId: question.chapter_id, topicId: question.topic_id, questionGroup: QUESTION_GROUPS?.find((group) => group.key === 'PYQ')?.value }"
            />
        </div>
    </div>
</template>
