    ...
    <div class="mt-6 p-4 border rounded-md bg-gray-50">
        ...
        <div v-if="mode === 'web'">
            <div class="mb-6">
                ...
                <div class="whitespace-pre-wrap" v-html="renderLatex(question.question.text)"></div>
            ...
            <div class="mb-6">
                ...
                <div class="whitespace-pre-wrap" v-html="renderLatex(question.answer.text)"></div>
                <div v-if="question.answer.images.length" class="flex flex-wrap gap-2 mt-2">
                    <img v-for="(img, idx) in question.answer.images" :key="'preview-a-img-' + idx" :src="getImagePath(img.path)" class="max-h-60" />
                </div>
            </div>

            <div v-if="question.solution.text || question.solution.images.length" class="mb-6">
                <h4 class="font-bold mb-2">Solution:</h4>
                <div class="whitespace-pre-wrap" v-html="renderLatex(question.solution.text)"></div>
