...
export default {
    ...
    methods: {
        ...
        onSubjectChange() {
            ...
            this.category.parent_id = this.selectedSubjectId;
        ...
        openNew() {
            this.category = {
                ...
                icon: '',
                depth_index: 'chapter',
                parent_id: this.selectedSubjectId
            };
        ...
        async saveCategory() {
            ...
            try {
                ...
                this.chapters = await this.transformChapterNodes(this.hierarchy, this.category.parent_id);
            } catch (error) {
                ...
                <Card>
                    <template #title>
                        <div class="flex flex-column gap-2 w-full">
                            <div class="text-lg font-medium">Question Subject :: :: Chapter</div>
                        </div>
                        <div class="flex align-items-center justify-content-between w-full mt-3">
                            ...
                            <Button v-if="canCreate()" label="Add New" icon="pi pi-plus" :disabled="selectedSubjectOption == null" @click="openNew" class="p-button-sm ml-2" />
                        </div>
                    </template>
                    <template #content>
                        <TreeTable tableStyle="min-width: 50rem" :value="chapters">
