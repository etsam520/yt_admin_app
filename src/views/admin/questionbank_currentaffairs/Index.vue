...
import CreateQuestion from '@/views/admin/questionbank_currentaffairs/CreateQuestion.vue';
...
async function fetchQuestions() {
    try {
        const response = await apiClient.get('/admin/questions?group=' + QUESTION_GROUPS.find((g) => g.key == 'CA').value);
        ...
        <div class="bg-white shadow rounded-lg p-4 mb-6" v-if="showQuestionsTable">
            <div class="flex flex-wrap gap-4 mb-4">
                ...
                <div class="flex-1 min-w-[200px]">
                    ...
                    <Dropdown v-model="filters.months" :options="months" optionLabel="label" optionValue="value" placeholder="All Months" class="w-full" />
                </div>
